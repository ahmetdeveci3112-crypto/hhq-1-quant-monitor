...
export interface Position {
  ...
  runtimeTacticalStopRoiPct?: number;
  runtimeTacticalStopSource?: string;
  runtimeTacticalStopPrice?: number;
  runtimeEmergencyFloorRoiPct?: number | null;
  runtimeEmergencyFloorPrice?: number;
  runtimeExchangeProtectiveMode?: string;
  runtimeLossProtectionAuthority?: string;
  runtimeExchangeProtectionAuthority?: string;
  runtimeExchangeProtectionRole?: string;
  runtimeExchangeProtectiveStopRoiPct?: number;
  runtimeExchangeProtectiveStopPrice?: number;
  runtimeStateDriftState?: string;
  runtimeStateDriftReason?: string;
  runtimeStateDriftSeverity?: number;
  runtimeIntentDecayPct?: number;
  runtimeStructuralInvalidationActive?: boolean;
  runtimeStructuralInvalidationSource?: string;
  runtimeStructuralInvalidationPrice?: number;
  runtimeStructuralInvalidationRoiPct?: number;
  runtimeStructuralInvalidationBufferAbs?: number;
  ...
  fakeoutReclaimHoldArmed?: boolean;
  fakeoutReclaimHoldUsed?: boolean;
  fakeoutReclaimHoldUntilTs?: number;
  fakeoutReclaimCandidateTs?: number;
  fakeoutReclaimArmRoiPct?: number;
  fakeoutReclaimReason?: string;
  fakeoutReclaimReleaseReason?: string;
  trailFakeoutGuardArmed?: boolean;
  trailFakeoutGuardUsed?: boolean;
  trailFakeoutGuardUntilTs?: number;
  trailFakeoutGuardTickCount?: number;
  trailFakeoutGuardReason?: string;
  trailFakeoutGuardReleaseReason?: string;
  trailFakeoutGuardState?: string;
  uiClosePending?: boolean;
  uiClosePendingReason?: string;
  uiCloseScheduledAt?: number;
  positionsObservedAt?: number;
  positionsSourceStale?: boolean;
  positionsSourceAgeSec?: number;
  positionsAuthority?: string;
  ...
  postExitFollowthroughActive?: boolean;
  postExitFollowthroughMode?: string;
  postExitPreferredSide?: string;
  postExitPreferredEntryFamilies?: string[];
  postExitFollowthroughConfidence?: number;
  postExitFollowthroughAgeSec?: number;
  postExitWatchRegisterResult?: string;
  postExitWatchRegisterReason?: string;
  postExitThinBookGraceUsed?: boolean;
  postExitExposureReserveUsed?: boolean;
  postExitExposureReserveReason?: string;
  oppositeReclaimSuppressed?: boolean;
  reversalRetestEntryMode?: string;
  reversalRetestPullbackPctOriginal?: number;
  reversalRetestPullbackPctApplied?: number;
  reversalRetestConfirmDelaySec?: number;
  reversalRetestExpiresSec?: number;
  reversalRetestExecutionPriority?: string;
  reversalRetestZoneState?: string;
  reversalRetestZoneReason?: string;
  reversalRetestZoneSource?: string;
  reversalRetestZonePrice?: number;
  reversalRetestZoneWidth?: number;
  reversalRetestPocketPrice?: number;
  reversalRetestRetestDistancePct?: number;
  reversalRetestTouchReady?: boolean;
  reversalRetestZoneConfidence?: number;
  ...
  microState5m?: string;
  setupState15m?: string;
  backdropState1h?: string;
  macroState4h?: string;
  ...
  preferredExitProfile?: string;
  coinStateSource?: string;
  coinStateVersion?: string;
  coinStateRouteReason?: string;
  runtimeExitProfile?: string;
  runtimeExitProfileReason?: string;
  runtimeExitOwner?: string;
  runtimeExitOwnerReason?: string;
  runtimeExitOwnerTightenBias?: number;
  runtimeExitOwnerAllowHold?: boolean;
  runtimeStateDriftState?: string;
  runtimeStateDriftReason?: string;
  runtimeStateDriftSeverity?: number;
  runtimeIntentDecayPct?: number;
...
export interface Trade {
  ...
  runtimeTacticalStopSource?: string;
  runtimeTacticalStopPrice?: number;
  runtimeEmergencyFloorRoiPct?: number;
  runtimeEmergencyFloorPrice?: number;
  runtimeExchangeProtectiveMode?: string;
  runtimeLossProtectionAuthority?: string;
  runtimeExchangeProtectionAuthority?: string;
...
export interface ReplaySearchResult {
  ...
  postExitWatchRegisterResult?: string;
  postExitWatchRegisterReason?: string;
  postExitResolutionMode?: string;
  postExitResolutionTargetSide?: string;
  postExitResolutionReason?: string;
  postExitResolutionConfidence?: number;
  postExitReentryEntryMode?: string;
  postExitReentryPullbackPctOriginal?: number;
  postExitReentryPullbackPctApplied?: number;
  postExitReentryConfirmDelaySec?: number;
...
export interface ScannerStats {
  ...
  postExitReentryRecentArmed?: number;
  postExitReentryRecentCancelled?: number;
  postExitReentryRecentTriggered?: number;
  postExitReentryRecentOppositeTriggered?: number;
  lastUpdate: number;
}
